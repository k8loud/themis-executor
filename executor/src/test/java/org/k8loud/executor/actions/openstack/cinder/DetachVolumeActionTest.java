...
import org.k8loud.executor.actions.openstack.DetachVolumeAction;
...
public class DetachVolumeActionTest extends OpenstackActionBaseTest {
    ...
    void testDetachSuccess() throws ActionException, OpenstackException {
        ...
        when(openstackServiceMock.detachVolume(anyString(), anyString(), anyString())).thenReturn(resultMap);
