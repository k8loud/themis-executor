...
public interface OpenstackService {
    ...
    Map<String, String> deleteServers(String region, String namePattern) throws OpenstackException, ValidationException;
    ...
    Map<String, String> throttle(String region, String serverId, String ethertype,
                                 String remoteIpPrefix, String protocol, int portRangeMin,
